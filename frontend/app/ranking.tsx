...
export default function RankingPage() {
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.content}>
          ...
          <View style={styles.errorContainer}>
            ...
            <ThemedText style={styles.errorText}>Raw data: {JSON.stringify(spotData)}</ThemedText>
          </View>
        </View>
      </SafeAreaView>
    );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Submitting ranking for spot:', safeSpot.id, 'with rating:', rating);
      ...
      console.log('Ranking data being sent:', JSON.stringify(rankingData, null, 2));
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.spotInfo}>
            ...
            <View style={styles.spotDetails}>
              ...
              <ThemedText style={styles.spotLocation}>📍 {safeSpot.location?.address || 'Unknown Location'}</ThemedText>
            </View>
          </View>

          {/* Rating Section */}
          <View style={styles.ratingSection}>
            <ThemedText style={styles.sectionTitle}>How would you rate this spot?</ThemedText>
